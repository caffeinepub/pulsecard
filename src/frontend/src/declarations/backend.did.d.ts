...
export interface _SERVICE {
  ...
  'addMedicalRecord' : ActorMethod<[string, MedicalRecord], undefined>,
  'assignCallerUserRole' : ActorMethod<[Principal, UserRole], undefined>,
  'convertMedicalProfileToPatientProfile' : ActorMethod<
    [string, string, Array<string>, string],
    PatientProfile
  >,
  'createOrUpdateProfile' : ActorMethod<[PatientProfile], undefined>,
